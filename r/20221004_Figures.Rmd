...
sites.all.msabpp <- dir_ls("formatted_data", regexp = "figure1") %>%
  fread() %>%
  select(protein_id, position, pPSE) %>%
  filter(!is.na(position),
         !is.na(pPSE)) %>%
...
#ggsave("plots/20221002/DrugDiscovery_Distributions.png", height = 3.5, width = 4)
...
#ggsave("plots/20221002/TheoreticalCoverage.png", height = 4.5, width = 7)
