...
### Filter for: Structured regions + quality > 70

# Bring together after and filter / select columns  /disctinc
#is.na position, is.na protein_id, multiple cys

#filter(!is.na(position),
#       !is.na(protein_id), ## Some gene names don't match -- removed from further analysis (298 / 6382 residues)
#       !str_detect(position, ",")) %>% ## Multiply annotated Cys (2+ cys per peptide) removed (None in this df)
...
write_csv(reformat.combined, "formatted_data/20221006_figure1_sites.csv")
