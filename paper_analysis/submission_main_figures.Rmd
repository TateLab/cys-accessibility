...
res.uniprot.formatted <- here("formatted_data") %>%
  dir_ls(regexp = paste0("20230313_figure2_uniprot")) %>%
  fread() %>%
...
res.proximal.aa <- here("resources") %>%
...
fragment.aa.pairwise <- here("resources") %>%
